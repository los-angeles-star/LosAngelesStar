...
const featuredMediaId = props.featuredMedia;
const postStore = usePostStore();
postStore.getPostMedia({featured_media: featuredMediaId});
const media = computed(() => {
	return postStore.postMedia;
})
const isLoaded = computed(() => Object.keys(media.value).length >= 1);
</script>
