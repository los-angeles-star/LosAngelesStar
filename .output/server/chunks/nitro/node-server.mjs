...
const _runtimeConfig = (function(a,b,c){return {app:{baseURL:a,basePath:a,assetsPath:b,cdnURL:c,buildAssetsDir:b},nitro:{routes:{},envPrefix:"NUXT_"},_app:{basePath:a,assetsPath:b,cdnURL:c,buildAssetsDir:b,baseURL:a},public:{_app:{basePath:a,assetsPath:b,cdnURL:c,buildAssetsDir:b,baseURL:a},app:{basePath:a,assetsPath:b,cdnURL:c,buildAssetsDir:b,baseURL:a}}}}("\u002F","\u002F_nuxt\u002F",""));
...
const _2dd914 = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '', handler: _ab2c5e, lazy: true, method: undefined },
  { route: '/_nitro', handler: _2dd914, lazy: true, method: undefined },
  { route: '/**', handler: _2dd914, lazy: true, method: undefined }
];
